...
import it.macgood.hotelapp.reservation.component.screen.FinalPriceCard
import it.macgood.hotelapp.reservation.component.screen.HotelInfo
import it.macgood.hotelapp.reservation.component.view.PayButton
import it.macgood.hotelapp.reservation.component.screen.ReservationDetailsTable
import it.macgood.hotelapp.reservation.component.screen.TouristCard
import it.macgood.hotelapp.reservation.component.screen.UnfoldTouristCard
import it.macgood.hotelapp.reservation.component.screen.InformationAboutCustomer
...
//            ReservationTopBar(navController)
        }
    ) { innerPaddings ->
        LazyColumn(
            modifier = Modifier
